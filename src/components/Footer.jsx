...
const Footer = () => {
  ...
  return (
    <footer className="bg-white text-[#3C467B] relative overflow-hidden">
      <div className="container-custom pl-4 pr-2 sm:pl-6 sm:pr-4 lg:pl-8 lg:pr-6">
        ...
        <div className="py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            <h3 className="text-lg sm:text-xl font-semibold border-b border-gray-300 pb-2 text-[#3C467B]">
              About AIMAN
            </h3>
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            <h3 className="text-lg sm:text-xl font-semibold border-b border-gray-300 pb-2 text-[#3C467B]">Quick Links</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <button
                  onClick={() => handleLinkClick('/')}
                  className="text-[#3C467B] hover:text-primary-600 hover:translate-x-1 transition-all duration-200 cursor-pointer text-left text-sm sm:text-base block w-full py-1"
                >
                  Home
                </button>
              </li>
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            <h3 className="text-lg sm:text-xl font-semibold border-b border-gray-300 pb-2 text-[#3C467B]">Services</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <button
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <a href="tel:+918800833411" className="text-[#3C467B] text-sm sm:text-base hover:text-primary-600 transition-colors">
                    +91 88008 33411
                  </a>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@aimanhealth.com" className="text-[#3C467B] text-sm sm:text-base hover:text-primary-600 transition-colors break-all">
        ...
        <div className="border-t border-gray-300 py-6 sm:py-8 pl-4 pr-2 sm:pl-6 sm:pr-4 lg:pl-8 lg:pr-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-[#3C467B] text-xs sm:text-sm text-center md:text-left">
              © {currentYear} AIMAN Hospital. All rights reserved.
            </p>
            <div className="flex flex-wrap justify-center gap-4 sm:gap-6 text-xs sm:text-sm">
              <button
                onClick={() => handleLinkClick('/privacy-policy')}
                className="text-[#3C467B] hover:text-primary-600 transition-colors duration-200 cursor-pointer"
              >
                Privacy Policy
              </button>
              <button
