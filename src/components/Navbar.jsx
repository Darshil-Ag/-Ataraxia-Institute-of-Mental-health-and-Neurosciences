        ...
        <div className="flex items-center justify-between h-20 lg:h-24 w-full">
                ...
                <button
                  ...
                  className={`font-medium transition-all duration-200 cursor-pointer ${
                    location.pathname === item.path
                      ...
                      : 'text-[#3C467B] hover:text-primary-500 hover:scale-105 drop-shadow-md'
                  }`}
                >
                  {item.name}
                </button>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <button
              ...
              className="flex items-center space-x-2 text-sm text-[#3C467B] hover:text-primary-600 transition-colors duration-200 cursor-pointer"
            >
          ...
          <button
            ...
            className="lg:hidden p-3 rounded-lg text-[#3C467B] hover:bg-gray-200 transition-colors duration-200"
