...
const AdminDoctors = () => {
  ...
  return (
    <div className="min-h-screen bg-primary-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-[#3C467B]">Manage Doctors</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredDoctors.map((doctor) => (
            ...
            >
              ...
              {/* Doctor Info */}
              <div className="p-4">
                <h3 className="text-lg font-semibold text-[#3C467B] mb-1">{doctor.name}</h3>
        ...
        {filteredDoctors.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-[#3C467B] mb-2">No doctors found</h3>
      ...
      <AnimatePresence>
        {showModal && (
          <div className="fixed inset-0 bg-[#3C467B] bg-opacity-50 flex items-center justify-center z-50 p-4">
            <motion.div
            ...
            >
              ...
              <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
                <h2 className="text-2xl font-bold text-[#3C467B]">
              ...
              <form onSubmit={handleSubmit} className="p-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    />
                    <label htmlFor="available" className="text-sm font-medium text-[#3C467B]">
                ...
                <div className="flex space-x-3 mt-6 pt-6 border-t">
                  <button
                    type="button"
                    onClick={handleCloseModal}
                    className="flex-1 px-4 py-2 border border-gray-300 text-[#3C467B] rounded-lg hover:bg-gray-50 transition-colors duration-200"
                  >
                    Cancel
                  </button>
                  <button
          ...
          <div className="fixed inset-0 bg-[#3C467B] bg-opacity-50 flex items-center justify-center z-50 p-4">
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-[#3C467B] mb-2">Delete Doctor?</h3>
