        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-[#3C467B]">Manage Blog Posts</h1>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {filteredBlogs.map((blog) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <h3 className="text-lg font-semibold text-[#3C467B] mb-2 line-clamp-2">
                  {blog.title}
                </h3>
        ...
        {filteredBlogs.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-[#3C467B] mb-2">No blog posts found</h3>
