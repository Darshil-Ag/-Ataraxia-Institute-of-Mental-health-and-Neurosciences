      ...
      <section className="section-padding bg-primary-100">
        <div className="container-custom">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#3C467B] mb-6">Our Vision</h2>
          </motion.div>
            ...
            <div className="lg:w-1/2">
              <div className="max-w-2xl">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-3xl font-bold text-[#3C467B]">Our Vision</h3>
                </div>
                <p className="text-lg text-[#3C467B] leading-relaxed">
                  {vision}
                </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-4xl md:text-5xl font-bold text-[#3C467B] mb-2">
                  {stat.number}
                </div>
                <div className="text-[#3C467B] font-medium">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="section-padding bg-primary-100">
        <div className="container-custom">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl md:text-5xl font-bold text-[#3C467B] mb-6">
              What Drives Us
            </h2>
            <p className="text-xl text-[#3C467B] max-w-4xl mx-auto mb-12 leading-relaxed">
                ...
                >
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#3C467B] leading-relaxed">
                        {value.description}
                      </p>
                    </div>
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {achievements.map((achievement, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-[#3C467B] mb-2">
                  {achievement.title}
                </h3>
