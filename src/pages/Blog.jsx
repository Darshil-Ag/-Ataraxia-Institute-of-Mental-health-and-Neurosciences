                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                    selectedCategory === category.id
                      ...
                      : 'bg-gray-100 text-[#3C467B] hover:bg-gray-200'
                  }`}
                >
                  {category.name}
                </button>
          ...
          <div className="container-custom">
            ...
            >
              <div className="flex items-center justify-center space-x-2 mb-4">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-[#3C467B]">
                  Featured Articles
                </h2>
              </div>
              ...
              {featuredPosts.map((post, index) => (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <span className="text-sm text-[#3C467B]">
                      {formatDate(post.date)}
                    </span>
                  </div>

                  <h3 className="text-2xl font-bold text-[#3C467B] mb-3 group-hover:text-primary-600 transition-colors duration-200">
                    {post.title}
                  </h3>

                  <p className="text-[#3C467B] mb-4 leading-relaxed">
                    {post.excerpt}
                  </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-[#3C467B]">
                          {post.author}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center space-x-2 text-sm text-[#3C467B]">
            ...
            <form onSubmit={handleNewsletterSubscription} className="max-w-md mx-auto">
              <div className="flex gap-4">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-lg text-[#3C467B] focus:ring-2 focus:ring-primary-500 focus:outline-none border border-gray-300"
                  required
                />
                <button 
                  type="submit"
