        ...
        <div className="container-custom">
          ...
          >
            <div className="bg-white rounded-2xl shadow-2xl p-8 sm:p-12">
              ...
              <h1 className="text-3xl sm:text-4xl font-bold text-[#3C467B] mb-4">
                Appointment Booked Successfully!
              </h1>
              <p className="text-lg text-[#3C467B] mb-8">
              ...
              <div className="bg-primary-50 rounded-lg p-6 mb-8">
                <h3 className="text-xl font-semibold text-[#3C467B] mb-4">What happens next?</h3>
                <ul className="text-left space-y-2 text-[#3C467B]">
  ...
  return (
    <div className="pt-20 lg:pt-24 relative">
      ...
      <section className="relative py-20 bg-gradient-to-br from-primary-500 via-primary-600 to-secondary-700 text-white">
        <div className="absolute inset-0 bg-[#3C467B] opacity-10"></div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#3C467B] mb-4">
                Schedule Your Visit
              </h2>
              <p className="text-base sm:text-lg text-[#3C467B] max-w-2xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    {/* Doctor Selection */}
                    <div>
                      <label className="block text-sm font-medium text-[#3C467B] mb-2">
                        Select Doctor *
                      </label>
                          ...
                          >
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex-1">
                                <h3 className="font-semibold text-[#3C467B]">{doctor.name}</h3>
                                <p className="text-sm text-primary-600">{doctor.specialty}</p>
                                <p className="text-xs text-[#3C467B]">{doctor.experience} experience</p>
                              </div>
                            </div>
                          </div>
                        ))}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                      />
                      <p className="text-xs text-[#3C467B] mt-1">
              ...
              <div className="space-y-6">
                ...
                <motion.div
                  ...
                  className="card"
                >
                  <h3 className="text-xl font-bold text-[#3C467B] mb-6">Appointment Booking Manual</h3>
                  
                  <div className="space-y-6">
                    {/* Step 1 */}
                    <div className="border-l-4 border-primary-500 pl-4">
                      <h4 className="text-lg font-semibold text-[#3C467B] mb-2">Step 1: Select Your Doctor</h4>
                      <p className="text-[#3C467B] text-sm">
                    ...
                    {/* Step 2 */}
                    <div className="border-l-4 border-primary-500 pl-4">
                      <h4 className="text-lg font-semibold text-[#3C467B] mb-2">Step 2: Choose Your Date</h4>
                      <p className="text-[#3C467B] text-sm">
                    ...
                    {/* Step 3 */}
                    <div className="border-l-4 border-primary-500 pl-4">
                      <h4 className="text-lg font-semibold text-[#3C467B] mb-2">Step 3: Pick Your Time</h4>
                      <p className="text-[#3C467B] text-sm">
                    ...
                    {/* Step 4 */}
                    <div className="border-l-4 border-primary-500 pl-4">
                      <h4 className="text-lg font-semibold text-[#3C467B] mb-2">Step 4: Fill Your Details</h4>
                      <p className="text-[#3C467B] text-sm">
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <h4 className="text-lg font-semibold text-[#3C467B] mb-3">Need Help?</h4>
                      <div className="space-y-2 text-sm text-[#3C467B]">
