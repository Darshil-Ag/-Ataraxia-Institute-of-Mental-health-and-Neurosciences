    ...
    <div className="pt-20 lg:pt-24 relative">
      ...
      <section className="section-padding bg-primary-100">
        <div className="container-custom">
          ...
          >
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#3C467B] mb-3 sm:mb-4">
              {selectedSpecialty === 'all' ? 'All Experts' : specialties.find(s => s.id === selectedSpecialty)?.name}
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-[#3C467B] max-w-3xl mx-auto px-4">
            ...
            {filteredDoctors.map((doctor, index) => (
              ...
              >
                ...
                <div className="text-center mb-4">
                  <h3 className="text-lg sm:text-xl font-semibold text-[#3C467B] mb-1">
                    {doctor.name}
                  </h3>
                ...
                <div className="space-y-2 mb-4 text-xs sm:text-sm text-[#3C467B]">
                ...
                {doctor.description && (
                  <p className="text-xs sm:text-sm text-[#3C467B] mb-4 line-clamp-2">
                    {doctor.description}
                  </p>
                )}
          ...
          {filteredDoctors.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-semibold text-[#3C467B] mb-2">
                No experts found
              </h3>
              <p className="text-[#3C467B]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-[#3C467B] mb-2">
                  {feature.title}
                </h3>
                <p className="text-sm sm:text-base text-[#3C467B]">
                  {feature.description}
                </p>
              </motion.div>
            ))}
      ...
      {/* Call to Action */}
      <section className="section-padding bg-primary-100">
        <div className="container-custom text-center text-[#3C467B]">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8 text-[#3C467B] max-w-3xl mx-auto px-4">
